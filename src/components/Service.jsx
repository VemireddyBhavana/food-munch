          ...
          {services.map((service, index) => (
            <li key={index}>
              <div className="service-card">
                <Link to={`/menu/${service.category}`} target="_blank" rel="noopener noreferrer" className="has-before hover:shine">
                ...
                <div className="card-content">
                  <h3 className="title-4 card-title">
                    <Link to={`/menu/${service.category}`} target="_blank" rel="noopener noreferrer">{service.title}</Link>
                  </h3>

    ...
    <section className="section service bg-black-10 text-center" aria-label="service">
      <div className="container">
        ...
        <ul className="grid-list">
          {[
            { img: '/assets/images/service-1.jpg', title: 'Breakfast' },
            { img: '/assets/images/service-2.jpg', title: 'Appetizers' },
            { img: '/assets/images/service-3.jpg', title: 'Drinks' }
          ].map((service, index) => (
            <li key={index}>
              <div className="service-card">
                <a href="#" className="has-before hover:shine">
                  <figure className="card-banner img-holder" style={{ '--width': 285, '--height': 336 }}>
                    <img src={service.img} width="285" height="336" loading="lazy" alt={service.title} className="img-cover" />
                  </figure>
                </a>
